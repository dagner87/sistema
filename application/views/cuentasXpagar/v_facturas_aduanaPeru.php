                    ...
                    <td>
                      <div class='row'>
                       ...
                       <span style='font-size: 1em;' class=''><strong><?= $item->no_recibo_adext;?></strong></span>
                        ...
                        <div class='col-md-4'>
                          <button class='btn btn-default eye' id='verfact' onclick='mostrar_detalle(<?= $item->id_paquete ;?>)' title='Ver detalles' <?php if ($item->no_recibo_adext == null) { echo "disabled='true'";} ?> ><i class='fa fa-eye'></i>
                           </button>
                         </div>    
                      </div> 
                   </td>
