    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                    <form action="<?php echo base_url();?>ventas/guardar_entrada" method="POST" class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control select2" style="" name="id_producto_entrada" id="id_producto_entrada" required="true">
                                ...
                                <div class="col-md-2">
                                    <label for="">&nbsp;</label>
                                    <button id="btn-agregar-entrada" type="button" class="btn btn-success btn-flat btn-block"><span class="fa fa-plus"></span> Agregar</button>
                                </div>
                            </div>
