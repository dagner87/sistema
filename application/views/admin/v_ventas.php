...
<head>
  ...
  <title>Panel de ventas Key</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header">Menú</li>
          <li class="treeview <?php if($this->uri->segment(2)=='categoria' || $this->uri->segment(2)=='producto'){echo 'active';}?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href='<?php echo site_url('ventas/categoria/3')?>'><i class="fa fa-circle-o text-yellow"></i> La Paz</a></li>
            <li>
              <a href="<?php echo site_url('ventas/categoria/3/add')?>">
                <i class="fa fa-plus text-yellow"> </i> Agregar Categoria
              </a>
            </li>
            <li class="treeview <?php if($this->uri->segment(2)=='categoria' || $this->uri->segment(2)=='producto'){echo 'active';}?>">
              <a href=""><i class="fa fa-circle-o text-aqua"> </i> Lista de Categorias
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              ...
              <?php  foreach($array1 as $item):?>
                    <li>
                      <a href='<?php echo site_url('ventas/producto/'.$item->id_categoria)?>'>
                        <i class="fa fa-circle-o text-aqua"></i><?= $item->nombre_categoria;?>
                      </a>
                     </li>
        ...
        <li class="treeview <?php if($this->uri->segment(2)=='N_entrada_productos' || $this->uri->segment(2)=='producto'){echo 'active';}?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href='<?php echo site_url('ventas/N_entrada_productos/add')?>'><i class="fa fa-circle-o text-aqua"></i>Nueva Entrada</a></li>
            <li><a href='<?php echo site_url('ventas/N_entrada_productos')?>'><i class="fa fa-circle-o text-red"></i> Listar Entrada Producto</a></li>
          </ul>
        </li>
       ...
       <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href='<?php echo site_url('ventas/reporte_existencia')?>'><i class="fa fa-circle-o"></i>Reporte Entradas</a></li>
            <li><a href='<?php echo site_url('ventas/reporte')?>'><i class="fa fa-circle-o"></i>Reporte de salidas </a></li>
          </ul>
        </li>
