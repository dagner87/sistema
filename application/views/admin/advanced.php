             ...
             <div class="panel-heading ">LOCALIZACION</div>
              ...
              <div class="col-md-6">
                <div class="form-group ">
                  ...
                  <label>Destino</label>
                  <select class="form-control select2" style="" name="id_sucursal" value="<?php echo set_value('id_sucursal'); ?>" required>
                   
                    <option selected="selected">Seleccionar Sucursal</option>
                     <?php
                    foreach ($consulta as $filas )
                           {
                      ?>
                    <option value='<?=$filas->id_sucursal ?>'><?=$filas->nombre_sucursal ;?> </option>
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                   ...
                   <td><button class="btn btn-block btn-danger" onclick="eliminar_producto()"><i class="glyphicon glyphicon-check"></i>Eliminar</button></td>
                  </td>         
                  </tr>
                  <?php    //endforeach; ?>
                  </tbody>
            ...
            <div class="box">
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php  foreach($productos_cli as $item):?>
                  <tr>
