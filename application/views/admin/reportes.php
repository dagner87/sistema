...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url();?>plantillas/index2.html" class="logo">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>plantillas/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Dagner Alena </span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
      ...
      <ul class="nav in" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url();?>" class="active"><i class="fa fa-dashboard fa-fw"></i>&nbsp;DASHBOARD</a>
                                                    ...
                                                    <li>
                                <a><i class="fa fa-users fa-fw"></i>&nbsp;VENTAS</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>productos"><i class="fa fa-caret-right fa-fw"></i>&nbsp;Stock de productos</a>
                            </li>
                           
                            <li>
                                <a href="<?php echo base_url();?>vendedor/venta_at_1"><i class="fa fa-caret-right fa-fw"></i>&nbsp; Proceso de venta</a>
                            </li>
        
                            <li>
                                <a href="<?php echo base_url();?>misiones_propuestas"><i class="fa fa-caret-right fa-fw"></i>&nbsp;Misiones a realizar</a>
                            </li>
                                                                            <li>
                                <a><i class="fa fa-check  fa-fw"></i>PANEL DE DESPACHOS</a>
                            </li>                        
                            <li>
                                <a href="<?php echo base_url();?>entregas_directas"><i class="fa fa-caret-right fa-fw"></i>Despachos directos</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>entregas_terceros"><i class="fa fa-caret-right fa-fw"></i>Despachos a terceros</a>
                            </li>
                                                                            <li>
                                <a><i class="fa fa-check  fa-fw"></i>PANEL DE SUPERVISORES</a>
                            </li> 
                             <li>
                                <a href="<?php echo base_url();?>clientes"><i class="fa fa-caret-right fa-fw"></i>&nbsp;Cartera de clientes</a>
                            </li>                         
                            <li>
                                <a href="<?php echo base_url();?>#"><i class="fa fa-caret-right fa-fw"></i>Desbloquear cliente</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>#"><i class="fa fa-caret-right fa-fw"></i>Limpiar temporales</a>
                            </li>
                                                                            <li>
                                <a><i class="fa fa-wrench  fa-fw"></i>SISTEMA</a>
                            </li>

                            <li>
                                <a href="<?php echo base_url();?>usuarios"><i class="fa fa-caret-right fa-fw"></i>Usuarios</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>obt_empresas"><i class="fa fa-caret-right fa-fw"></i>Empresas flete</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>obt_revendedores"><i class="fa fa-caret-right fa-fw"></i>Revendedores</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>obt_configuraciones"><i class="fa fa-caret-right fa-fw"></i>Configuración</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>obt_causa_fallas"><i class="fa fa-caret-right fa-fw"></i>Causas de misiones fallidas</a>
                            </li>
           </ul>
    </section>
    <!-- /.sidebar -->
    ...
    <section class="content">
        ...
        <div class="box-body">
         <div class="row">
            ...
            <form role="form" action="<?php  echo base_url() ?>controlpanel/exportar_pdf" method="post" >
              

            <div class="panel panel-primary ">
             <div class="panel-heading ">Reporte de salidas Almacen Santa Cruz</div>
              <div class="panel-body">
                <div class="form-group ">
               
                  <label>Provincia</label>
                  <select class="form-control select2" style="width: 100%;" name="id_mes" value="<?php echo set_value('id_mes'); ?>"required>
                  ...
                  <select class="form-control select2" style="width: 100%;" name="id_producto" value="<?php echo set_value('id_producto'); ?>" required>
                    <option selected="selected">Seleccionar Producto</option>
                     <?php
                    foreach ($productos->result() as $filas )
                           {
                      ?>
                    <option value='<?=$filas->id_producto ?>'><?=$filas->nombre_producto ;?> </option>
              ...
              <div class="box-footer">
                <div class="col-md-6">
                  ...
                  <button type="submit" class="btn btn-info pull-right">Siguiente</button>
                </div>
             </div>
