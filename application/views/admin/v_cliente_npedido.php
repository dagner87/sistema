...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url();?>cliente" class="logo">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li >
           <a href='<?php echo site_url('cliente/n_pedido_cli')?>'>
            <i class="fa fa-circle-o text-aqua"></i> Nuevo Pedido
          </a>
        </li>
        <li class="treeview 
        <?php if($this->uri->segment(2)=='proveedor' || $this->uri->segment(2)=='pedido_proveedor'){echo 'active';}?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href='<?php echo site_url('cliente/pedido_proveedor/add')?>'><i class="fa fa-circle-o text-aqua"></i> Nuevo Pedido</a></li>

            <!--onclick="descripcion('<?= $filaa->descripcion_producto  ?>')-->
            
            <li><a href='<?php echo site_url('cliente/pedido_proveedor')?>'><i class="fa fa-circle-o text-red"></i>Listar Pedido</a></li>
          </ul>
        </li>
        <li class="treeview <?php if($this->uri->segment(2)=='pedido_transito' || $this->uri->segment(2)=='pedido_aduana'){echo 'active';}?>">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href='<?php echo site_url('cliente/pedido_transito')?>'><i class="fa fa-circle-o text-yellow"></i>Transito</i>
            <span class="label pull-right bg-yellow"><?= $count_entransito ;?> </span></a></li>
            <li><a href='<?php echo site_url('cliente/pedido_aduana')?>'><i class="fa fa-circle-o text-aqua"></i> Aduana <span class="label pull-right bg-blue"> <?= $count_enaduana ;?></span></a> </li>
            
          </ul>
        </li>
        <li>
          <a href='<?php echo site_url('cliente/pedido_enkey')?>'>
      ...
      <ol class="breadcrumb">
         <?php
                ...
                foreach($breadcrum as $item=>$valor)
                  {?>
                  <li><a href="<?php echo site_url("cliente/".$item); ?>"><i class="fa fa-dashboard"></i><?php echo $valor ; ?></a></li>
    ...
    <section class="content">
        ...
        <div class="box-body">
         <div class="row">
            ...
            <form role="form" action="<?php  echo base_url() ?>vendedor/validar_datos" method="post" >
              

            <div class="panel panel-primary ">
             <div class="panel-heading ">LOCALIZACION</div>
              <div class="panel-body">
                <div class="form-group ">
                
                  <label>Provincia</label>
                  <select class="form-control select2" style="" name="id_provincia" value="<?php echo set_value('id_provincia'); ?>" required>
                    ...
                    foreach ($consulta as $filas )
                           {
                      ?>
                    <option value='<?=$filas->id_provincia ?>'><?=$filas->nombre_sucursal ;?> </option>
                  ...
                  <select class="form-control select2" style="width: 100%;" name="id_municipio" value="<?php echo set_value('id_municipio'); ?>"required>
                    <option selected="selected">Seleccionar Municipio</option>
                     <?php
                    foreach ($consulta as $filas )
                           {
                      ?>
                    <option value='<?=$filas->id_municipio ?>'><?=$filas->nombre_sucursal ;?> </option>
            ...
            <div class="panel panel-primary ">
             <div class="panel-heading "><button class="btn btn-info" onclick="agregar_producto()"><i class="glyphicon glyphicon-check"></i>AGREGAR PRODUCTOS</button></div>
              <div class="panel-body">
                <div class="form-group ">
                  <div class="box">
              <!-- /.box-header -->
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><input type="text" class="form-control"   name='telefono' value="<?php echo set_value('telefono'); ?>" required></td>
                   <td><button class="btn btn-info" onclick="eliminar_producto()"><i class="glyphicon glyphicon-check"></i>Eliminar</button></td>
                  </td>         
                  </tr>
                  <?php    //endforeach; ?>
                  </tbody>
            ...
            <div class="box-footer">
                <div class="col-md-6">
                  ...
                  <button type="submit" class="btn btn-info pull-right">Realizar Pedido</button>
                </div>
             </div>
...
<div class="modal fade" id="modal_listar" role="dialog" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td> <?= $item->nombre_producto;?></td>
                    <td> 5</td>
                    <td> <button class="btn btn-info" onclick="add_person(<?= $item->id_producto;?>)"><i class="glyphicon glyphicon-check"></i>Agregar</button>
 ...
 function add_person(id)
{
   ...
   // $('#modal_form').modal('show'); // show bootstrap modal
    $('.modal-title').text('Producto: '+id); // Set Title to Bootstrap modal title
}
 ...
 function listar_productos()
{
    ...
    $('.modal-title').text('Listado de Productos'); // Set Title to Bootstrap modal title
}
