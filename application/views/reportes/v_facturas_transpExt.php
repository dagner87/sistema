...
<head>
  ...
  <title>Facturas de Transporte Perú</title>
          ...
          <div class="col-xs-12">
              <div class="box box-success">
                <div class="box-header">
                  <h3 class="box-title"><strong>Facturas de Transporte Externo Perú</strong>&nbsp;</h3>

                  <a class="btn btn-success" href='<?php echo site_url('comprador/facturas_transpExtPagadas')?>' title='Ver Facturas Pagadas'><i class="fa fa-inbox"> </i> Facturas Pagadas </a>
                ...
                <div class="box-body" id="areaImprimir">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php   
                       ...
                       if ($this->uri->segment(2)=='facturas_transpExtPagadas') {
                           ...
                           <?php  
                            if ($item->estado_pago==1) {
                             echo "<td>&nbsp;&nbsp;</td>";
                              ...
                              echo "<td>";
                              echo" <button id='pagarfact' class='btn btn-block btn-info btn-sm' onclick='pagar_facturaTranspExt(".$item->id_mercatrans.")' title='Confirmar Pago'><i class='fa fa-dollar'> Pagar</i></button>";
                              echo"</td>";
                               }    
                        ?> 
                        <td>
