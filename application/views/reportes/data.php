...
<head>
  ...
  <title>Facturas de Proveedores</title>
     ...
     <div class="col-xs-12">
          <div class="box box-success">
            <div class="box-header">
              ...
              <a class="btn btn-success" href='<?php echo site_url('comprador/facturas_proveedoresPagadas')?>' title='Ver Facturas Pagadas'><i class="fa fa-inbox"> </i> Facturas Pagadas </a>
            ...
            <div class="box-body" id="areaImprimir">
              <table id="example1" class="table table-bordered table-striped">
                 ...
                 <?php  
                  ...
                  ?>
                    <tr>
                       ...
                       <?php  
                       if ($item->estado_pagado==1) {
                         echo "<td>&nbsp;&nbsp;</td>";
                       }else{
                          echo "<td>";
                          echo" <button class='btn btn-block btn-info btn-sm' onclick='agregar_costos(".$item->id_paquete.")' title='Confirmar Pago'><i class='fa fa-dollar'> Pagar</i></button>";
                          echo"</td>";
                       }
                    ...
                    <?php
                      $fecha_actual = date('Y-m-d');
                       if ($fecha_actual > $item->fecha_tope_pago_fact){ ?>
                           <td><span style='font-size: 1em;' class="label label-warning"><?= $item->fecha_tope_pago_fact;?></span></td>
                        <?php  }elseif ($fecha_actual <= $item->fecha_tope_pago_fact) {  ?>
                           <td><span style='font-size: 1em;' class=""><?= $item->fecha_tope_pago_fact;?></span></td>
                           <?php  } ?>
                ...
                endforeach; 
                              ...
                              echo "<td colspan='' align='center'><div class=''><span style='font-size: 1em;color:red'> </span></div></td>";
                              echo "<td colspan='' align='center'><div class=''><span style='font-size: 1em;color:red'></span></div></td>";
                              echo "<td></td>";
                              echo "<td></td>";
                              echo "<td colspan='' align='center'><div class=''><span style='font-size: 1em;color:red'>No Hay datos q mostrar </span></div></td>";
                              echo "<td></td>";
                              echo "<td></td>";
                              echo "<td></td>";
                              echo "<td></td>";
