...
<head>
  ...
  <!-- Morris charts -->
  <link rel="stylesheet" href="<?php echo base_url();?>plantillas/plugins/morris/morris.css">
      ...
      <ul class="sidebar-menu">
       ...
       <?php endif; ?>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href='<?php echo site_url('comprador/facturas')?>' id="ver_factura" onClick="">
            <i class="fa fa-file-text"></i>Facturas de Proveedores </a></li>
          </ul>
        </li>
         ...
         <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Tiempo de Trayectoria</h3>
...
<script src="<?php echo base_url();?>plantillas/plugins/morris/morris.min.js"></script>
...
<script>
    ...
    var area = new Morris.Area({
      ...
      resize: true,
      data: [
        {y: '2011 Q10', item1: 5660, item2: 8666},
      ...
      xkey: 'y',
      ykeys: ['item1', 'item2'],
      labels: ['ROLLOS 80X80', 'TARJETAS CON CHIP BNB'],
