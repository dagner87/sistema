...
<head>
  ...
  <title>Facturas de Aduana Bolivia</title>
     ...
     <div class="col-xs-12">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title"><strong>Facturas de Aduana Bolivia </strong> &nbsp;</h3>
               <a class="btn btn-success" href='<?php echo site_url('comprador/facturas_PagasaduanaBol')?>' title='Ver Facturas Pagadas'><i class="fa fa-inbox"> </i> Facturas Pagadas </a>
                ...
                <tr>
                 <tr>
                  ...
                  <th>Fecha Pagada</th>
                   ...
                   if ($this->uri->segment(2)=='facturas_PagasaduanaBol') {
                    ...
                    <tr>
                       ...
                       <?php 
                         ...
                         echo "<td>&nbsp;&nbsp;</td>";
                            ...
                            echo "<td>";
                            echo" <button id='pagarfact' class='btn btn-block btn-info btn-sm' onclick='pagar_facturaAduanaBol(".$item->id_mercaduanabol.")' title='Confirmar Pago'><i class='fa fa-dollar'> Pagar</i></button>";
                            echo"</td>";
                           }
