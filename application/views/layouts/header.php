...
<head>
    ...
    <!-- validation -->
    <script type="text/javascript" src="<?php echo base_url();?>assets/template/jquery-validation-1.17.0/lib/jquery-1.7.2.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>assets/template/jquery-validation-1.17.0/dist/jquery.validate.js"></script>
      <!-- Ionicons -->
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-warning"><?= $count_entransito = 0  ;?></span>
            </a>
          ...
          <li class="dropdown messages-menu">
            <a href='' class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-info"><?= $count_enaduana =0;?></span>
            </a>
          ...
          <li class="dropdown notifications-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-danger"><?= $count_pendientes =0; ?></span>
            </a>
          ...
          <li class="dropdown tasks-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-success"><?= $count_completado =0 ;?></span>
            </a>
