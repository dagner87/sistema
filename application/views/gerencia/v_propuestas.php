...
<head>
  ...
  <title>Propuestas a Clientes</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     <div class="row">
      ...
      <!-- SELECT2 EXAMPLE -->
      <div class="box box-success" id="form_costo_terrestre"  style="">
        <div class="box-header with-border">
          <h3 class="box-title">Propuesta a clientes </h3>
        ...
        <div class="box-body">
          ...
          <form action="<?php echo base_url();?>comprador/updatecosto_terrestre" method="POST" enctype="multipart/form-data">
            <div class="col-xs-6">
              ...
              <!-- /.form-group -->
              <div class="form-group">
                <label>Clientes <span class="required"><strong style="color: red">*</strong></span></label>
                <select class="form-control select2" style="width: 100%;" required="true">
                   <option value="" selected>Seleccione Cliente </option >
                   <?php  foreach ($result_clientes as $fila) : ?>  
                ...
                <div class="form-group">
                  <label>Días de notificacion: <strong style="color: red">*</strong></label>
                  <div class="input-group">
                    <div class="input-group-addon">
                 ...
                 <div class="form-group">
                <label>Respaldo de Prepuesta:</label>
                <div class="input-group">
                  <div class="input-group-addon">
            ...
            <div class="col-xs-6">
              <div class="form-group">
                <label>Producto <span class="required"><strong style="color: red">*</strong></span></label>
                <select class="form-control select2" style="width: 100%;" required="true">
                   <option value="" selected>Seleccione Producto </option >
                   <?php  foreach ($result_productos as $fila) : ?>  
                ...
                <div class="input-group">
                  ...
                  <?php
                     $data = array(
                                    ...
                                    'name'   => 'no_poliza',
                                    'class'  => 'form-control',
                                    'style'  => 'margin: 0px; width: 266px; height: 123px;'
                                  );
          ...
          <div class="col-xs-3">
              <div class="form-group">
                <input type="submit" class="btn btn-block btn-default" value="Limpiar">    
    ...
    <section class="col-md-12">
      ...
      <div class="box box-success" id="form_costo_terrestre"  style="">
        <div class="box-header with-border">
          <h3 class="box-title">Lista a Confirmar</h3>
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> Key Solutions S.R.L
            <small class="pull-right">Día: <?php echo date('d/m/Y');?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          ...
          <address>
            <strong>Key Solutions S.R.L</strong><br>
           Barasea 414 Barrio Urbarí<br>
            Santa Cruz, Bolivia<br>
            Tel: (+591) 3-335-7278<br>
            Correo: rpestana@keysolutions.com.bo
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
          Señores:
          <address>
            <strong>Banco Fassil S.A.</strong><br>
            Sra. Aracely Yabeta Encinas<br>
            Av. Uruguay Nº 380  <br>
            Aux. de Compras y Gestion de Proveedores <br>
           Tel. 315 8306 I Tel. Piloto 315 8000 Int. 8306<br>
            Correo: ayabeta@fassil.com.bo
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
            ...
            <tr>
              <td>100</td>
              <td>ROLLO ATM FASSIL CHICO</td>
              <td>Rollos WINCOR : 80mm x 230mm x 25mm de buje interno – el térmico y la taca van hacia afuera a 2x1 color (1 color en ambos lados + negro de la taca)</td>
             
              <td>US$ 20.00</td>
              <td>US$ 2,000.00</td>
                <td><a class='btn btn-block btn-danger' onclick='' title='Eliminar'><i class='fa fa-trash'></i></a></td>
            </tr>
            <tr>
              <td>150</td>
              <td>ROLLO ATM FASSIL GRANDE</td>
              <td>Rollos WINCOR : 80mm x 170mm x 25mm de buje interno – el térmico y la taca van hacia afuera a 2x1 color (1 color en ambos lados + negro de la taca)</td>
             
              <td>US$ 15.50</td>
              <td>US$ 2,325.00</td>
              <td>
                 <a class='btn btn-block btn-danger' onclick='' title='Eliminar'><i class='fa fa-trash'></i></a>
              </td>
            </tr>
           </tbody>
          </table>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <!--button type="button" class="btn btn-success pull-right"><i class="fa fa-credit-card"></i> Guardar propuesta
          </button-->
     ...
     <div class="col-xs-12">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title"><strong>Facturas de Proveedores</strong>&nbsp;</h3>
              <a class="btn btn-success" href='<?php echo site_url('gerencia/facturas_proveedoresPagadas')?>' title='Ver Facturas Pagadas'><i class="fa fa-inbox"> </i> Facturas Pagadas </a>
