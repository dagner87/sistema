          ...
          <div class="box box-success">
            ...
            <div class="box-body " id="areaImprimir">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                 <tr>
                  <th colspan="5"><div align="center">ARTICULOS SOLICITADOS</div></th>
                  <th colspan="3"><div align="center">LIQUIDACION ADUANA BOLIVIA</div></th>
                ...
                foreach($arraypedidosKey as $item):
                    ...
                    foreach($result_datospaquete as $paq_ped):
                     ...
                     $datos_proveedor = $this->modelogeneral->datos_proveedor($datos_producto->id_proveedor);
                       ...
                       $costo_total.= " $".$datos_producto->costo_total."<br>";                            
                       endforeach;
                 ...
                 <?php  
                  ...
                  ?>
                  <td><?= "$ ".$costo = 
                                        $item->costo_transp_ext+      //TRANSPORTE PERU
                                        $item->costo_aduana_ext+      //ADUANA PERU
                                        $item->costo_transporte_bol+  //TRANSPORTE BOLIVIA
                                        $item->monto_poliza+          //ADUANA BOLIVIA
                                        $costo_total;                 // FACTURA PROVEEDOR
                        ?>
